...
- we are building [**Gauzy**](https://github.com/ever-co/gauzy) project to calculate bonuses from Income based on Profit bases. Meanwhile we calculating both themes bonuses manually for each employee / contractor individually.
